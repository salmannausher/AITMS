      ...
      <div className="hidden lg:flex lg:w-[420px] shrink-0 flex-col justify-between p-10" style={{ backgroundColor: 'hsl(var(--sidebar))' }}>
        ...
        <div className="space-y-6">
          <blockquote className="text-white text-xl font-medium leading-relaxed">
            "One dispatcher managing 3× the loads — that's what AI dispatch looks like."
          </blockquote>
          <div className="space-y-3">
            {[
              'Parses rate-cons from broker emails automatically',
              'AI scores every load: GOOD · MARGINAL · AVOID',
              'One-click WhatsApp assignment to your drivers',
            ].map((point) => (
      ...
      <div className="flex flex-1 items-center justify-center px-6 py-12 bg-background">
        <div className="w-full max-w-sm space-y-7">
          ...
          <p className="text-center text-sm text-muted-foreground">
            No account?{' '}
            <a href="/signup" className="font-medium text-foreground underline-offset-4 hover:underline" style={{ color: 'hsl(var(--primary))' }}>
              Create one
            </a>
          </p>
        </div>
